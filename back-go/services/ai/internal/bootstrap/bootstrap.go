// Package bootstrap собирает граф зависимостей ai-сервиса.
...
import (
	...
	aiv1 "github.com/DmitriyODS/gw2/back-go/gen/proto/ai/v1"
	"github.com/DmitriyODS/gw2/back-go/services/ai/internal/config"
...
func New(_ context.Context, cfg config.Config) (*App, error) {
	...
	aiv1.RegisterAIServiceServer(grpcSrv, &aiStubServer{})
