// Package bootstrap собирает граф зависимостей messenger-сервиса.
...
import (
	...
	messengerv1 "github.com/DmitriyODS/gw2/back-go/gen/proto/messenger/v1"
	"github.com/DmitriyODS/gw2/back-go/services/messenger/internal/config"
...
func New(_ context.Context, cfg config.Config) (*App, error) {
	...
	messengerv1.RegisterMessengerServiceServer(grpcSrv, &messengerStubServer{})
...
type messengerStubServer struct {
