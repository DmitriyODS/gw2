// Package bootstrap собирает граф зависимостей users-сервиса.
// На Этапе 1 — только REST /v1/health и gRPC stub. Реальные репозитории,
// presence и identicon добавляются на Этапе 3.
package bootstrap
...
import (
	...
	usersv1 "github.com/DmitriyODS/gw2/back-go/gen/proto/users/v1"
	"github.com/DmitriyODS/gw2/back-go/services/users/internal/config"
...
func New(_ context.Context, cfg config.Config) (*App, error) {
	...
	usersv1.RegisterUsersServiceServer(grpcSrv, &usersStubServer{})
