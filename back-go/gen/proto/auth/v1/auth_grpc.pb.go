...
const (
	AuthService_VerifySession_FullMethodName = "/groovework.auth.v1.AuthService/VerifySession"
)
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "groovework.auth.v1.AuthService",
