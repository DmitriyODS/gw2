...
var (
	ErrBoardNotFound  = NewError("NOT_FOUND", "Доска не найдена", 404)
	...
	ErrBadCollabKind    = NewError("VALIDATION", "Тип collab-события: join, leave, cursor или scene", 400)
	...
	ErrNothingToExport  = NewError("EMPTY_EXPORT", "Нечего экспортировать — здесь пока нет досок", 404)
)
