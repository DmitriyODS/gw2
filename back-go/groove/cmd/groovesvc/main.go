// groovesvc — микросервис «Мой Groove» Groove Work: доска признания (лента
// вех и благодарностей), реакции, комментарии, кудосы, питомцы-Грувики,
// зоопарк, магазин, недельные рейды и AI-механики Грувика.
//
// Транспорты:
