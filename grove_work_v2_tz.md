# Groove Work v2.0 — Техническое задание
...
**Groove Work** — внутренняя платформа для учёта времени выполнения задач, отслеживания количества задач и просмотра аналитики. Система ориентирована на команды с разграниченными ролями доступа.
...
*Документ является полной спецификацией для разработки Groove Work v2.0. Вопросов, требующих уточнения, не осталось.*
