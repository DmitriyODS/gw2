...
/* Переход по карточке считается ответом на неё: строка убирается. Иначе
   уведомление о разовом событии (сработавшее напоминание, вышедшее
   обновление) висело бы в центре и после того, как человек по нему сходил. */
function go(item) {
