<template>
  ...
  <AppCard
    title="Раскладка"
    hint="Окна удобны мышью, плитки и зоны — пальцем, «Виджеты» — привычная боковая панель разделов. По умолчанию выбираем сами: сенсорный экран получает планшетную раскладку, остальные — окна."
  >
    <AppRow
...
const activeText = computed(() => {
  ...
  if (shell.value === 'widgets') {
    return 'Сейчас «Виджеты»: слева панель разделов живыми плитками, справа один раздел. Панель тянут за границу и сворачивают до полоски значков, плитки перетаскиваются между категориями. Открытыми держатся до пяти разделов — самый давний закрывается сам.'
  }
