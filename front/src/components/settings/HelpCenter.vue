      ...
      ...(hasCompany() ? [
        {
          ...
          steps: [
            ...
            'Добавьте в текст #хештеги — по ним пост потом легко найти.',
            'Пост можно переслать коллеге в мессенджер — он придёт карточкой со ссылкой.',
          ],
          tips: [
            'Разделы ленты создаёт администратор компании; хештеги в постах ставит любой автор — их не нужно заводить заранее.',
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        steps: [
          'Откройте «Настройки» → «О приложении».',
          'Нажмите «Проверить обновления» — если есть новая версия, появится кнопка загрузки.',
          'На телефоне и ПК подтвердите установку скачанного файла; в браузере просто обновите страницу.',
        ],
        tips: [
          'Текущую версию всегда видно в разделе «О приложении».',
          'Если чего-то не хватает или интерфейс выглядит устаревшим — первым делом обновите страницу или проверьте обновления.',
        ],
      },
    ],
  },
