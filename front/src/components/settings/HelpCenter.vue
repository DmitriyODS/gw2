    ...
    articles: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Как только вы измените цвета (вручную или через «Мне повезёт»), внизу появится кнопка «Сохранить изменения» — имя подставится само («Моя тема 1»), при желании смените его. Без сохранения превью откатится при выходе из раздела — об этом предупредим.',
    ...
    articles: [
      {
        ...
        tone: 'primary',
        paragraphs: [
          'Создание новых сотрудников, назначение ролей и исключение из компании. Доступно с уровня «Администратор».',
        ...
        tips: [
          ...
          'Исключённый сотрудник теряет доступ к данным компании, но история его работы сохраняется.',
        ],
      },
      {
        id: 'lists-admin',
