    ...
    articles: [
      {
        ...
        tips: [
          'Найти переписку и написать сообщение можно прямо из Hola: «напиши Васе созвон в 15:00» отправит текст и откроет чат.',
    ...
    articles: [
      {
        ...
        paragraphs: [
          ...
          'Там же — подписка, внешние аккаунты (Яндекс, YouGile) и список сеансов: видно, с каких устройств открыт ваш аккаунт, и любой из них можно завершить.',
        ],
      },
      {
        id: 'theme',
