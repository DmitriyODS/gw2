  ...
  ...(isAtLeast(ROLES.ADMIN) ? [{
    ...
    articles: [
      ...
      },
      {
        ...
        title: 'Отделы',
        subtitle: 'Группировка сотрудников',
        icon: 'apartment',
        tone: 'secondary',
        paragraphs: [
          'Отделы используются для группировки сотрудников и в фильтрах статистики. Создавать и редактировать — с уровня «Менеджер».',
        ],
      },
      {
        id: 'unit-types-admin',
        title: 'Типы юнитов',
        subtitle: 'Категории работы',
        icon: 'category',
        tone: 'tertiary',
        paragraphs: [
          'Типы юнитов — это категории работы: «Дизайн», «Монтаж», «Корректура». Без них юниты создавать нельзя — добавьте хотя бы один.',
        ],
        tips: [
          'Удаление типа удаляет все юниты этого типа безвозвратно — будьте внимательны.',
        ],
      },
    ],
  }] : []),
