...
const allSteps = computed(() => [
  ...
  },
  {
    ...
    text: 'Одно окно на три задачи: поиск по всем разделам и в интернете, быстрые команды («создай задачу», «напомни завтра в 9», калькулятор) и чат с ИИ, который отвечает о задачах и статистике компании по реальным данным.',
    tip: 'На рабочем столе Hola живёт кнопкой в панели задач и открывается по Ctrl+K.',
    target: '[data-tutorial="nav-hola"]',
    navigateTo: '/hola',
  },
  {
    id: 'stats',
  ...
  },
  {
    ...
    text: 'Кликните по аватару в сайдбаре (на телефоне — «Ещё» → «Аккаунт») — попадёте в «Настройки → Аккаунт». Там фото, телефон, email, пароль и список ваших сеансов.',
