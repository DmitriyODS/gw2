        ...
        <div v-show="activeSection === 'backup'" class="pane-block">
          <div class="settings-card">
            ...
            <div class="card-text">
              ...
              <p>Полный архив базы данных и всех файлов (вложения чатов, аватары, картинки и документы разделов) в одном файле. Сохраняйте регулярно — на всякий случай.</p>
            </div>
...
.settings-nav-item.active {
  ...
  background: var(--glass-bg), color-mix(in oklch, var(--color-primary-container) 45%, transparent);
  box-shadow: var(--glass-edge);
}
