<template>
  <div class="pr">
    ...
    <section class="pr-hero">
      <p class="pr-eyebrow reveal">платформа для команд</p>
      <h1 class="pr-display reveal">Вся работа команды — в одном окне</h1>
      <p class="pr-lead reveal">
        Задачи и учёт времени, переписка и звонки, документы и портал.
        Groove Work собирает рабочий день в одном месте — без десятка вкладок,
        подписок и сервисов, которые не знают друг о друге.
      </p>
    ...
    <section id="features" class="pr-section">
      <h2 class="pr-h2 reveal">Всё, из чего состоит рабочий день</h2>
      <p class="pr-section-lead reveal">
        Разделы живут в одной платформе и знают друг о друге: задача уезжает в чат,
        заметка становится постом, звонок оставляет плашку в переписке.
      </p>
      <div class="pr-grid">
    ...
    <section class="pr-split reveal">
      <div class="pr-split-text">
        ...
        <p>
          Разделы открываются окнами: задачи рядом с перепиской, календарь поверх
          статистики. Панель задач, меню «Пуск» с живыми плитками и обои — рабочее
    ...
    <section class="pr-split pr-split--rev reveal">
      <div class="pr-split-text">
        ...
        <p>
          Юнит запускается одной кнопкой и останавливается вместе с задачей — время
          попадает в отчёты без табелей и напоминаний. Руководителю видна загрузка
          отделов и сотрудников, а на офисном экране статистика идёт табло в ТВ-режиме.
        </p>
      </div>
      <div class="pr-split-visual" aria-hidden="true">
        <div class="pr-chart">
...
const PILLARS = [
  {
    icon: 'timer', title: 'Время под контролем',
    text: 'Юниты считают работу по задачам сами — отчёт собирается к концу дня без табелей.',
  },
  {
    icon: 'forum', title: 'Команда на связи',
    text: 'Чаты, группы, звонки и корпоративный портал — внутри платформы, без сторонних сервисов.',
  },
  {
    icon: 'inventory_2', title: 'Знания на месте',
    text: 'Заметки, доски, календари и реестры компании: всё, что раньше жило в файлах и таблицах.',
  },
]
...
const FAQ = [
  {
    q: 'Сколько стоит?',
    a: 'Базовый тариф бесплатный: команда, задачи, переписка и звонки доступны сразу. Платные тарифы расширяют лимиты — место, число сотрудников, расширенную статистику и обращения к ИИ.',
  },
  {
    q: 'Нужно ли переносить данные?',
    a: 'Не обязательно. Задачи можно вести с нуля, а при работе в YouGile — подключить доску и синхронизировать карточки в обе стороны.',
  },
  {
    q: 'Можно состоять сразу в нескольких компаниях?',
    a: 'Да. Аккаунт принадлежит человеку, а не компании: в каждой у вас своя роль, переключение — одним нажатием. Переписка и личные заметки при этом общие для всех ваших компаний.',
  },
  {
    q: 'Кто видит статистику сотрудников?',
    a: 'Свои часы видит каждый, сводку по отделам и людям — менеджеры и администраторы компании. Платформенный администратор к рабочим данным компаний доступа не имеет.',
  },
  {
