  ...
  return [
    {
      ...
      sections: [
        ...
        { key: 'theme', title: 'Темы и оформление', desc: 'Светлая и тёмная тема, палитры, свои цвета, обои и градиент фона', icon: 'palette', tone: 'primary' },
        // Раскладка и живые плитки — общая настройка, синхронизируется на всех
        // устройствах и видна на мобильном стартовом экране тоже (панель задач
        // там просто ни на что не влияет, но менять её можно откуда угодно).
        { key: 'desktop', title: 'Рабочий стол', desc: 'Каркас приложения, панель задач и меню «Пуск», живые плитки', icon: 'desktop_windows', tone: 'tertiary' },
