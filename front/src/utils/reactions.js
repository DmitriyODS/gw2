 ...
 * согласие, эмоции, рабочие пометки (как в Telegram/Slack).
 *
 * Порядок в первой строке неслучаен: там то, чем отвечают чаще всего, — «ок»,
 * «согласен», «готово». Ниже — эмоции и остальное.
 *
 * Эмодзи рисует системный шрифт (не забандленные Twemoji, как у грувиков),
 * поэтому набор намеренно держится в пределах широко поддержанных символов:
 * свежие кодовые точки на старых Android показались бы пустым квадратом.
 */
