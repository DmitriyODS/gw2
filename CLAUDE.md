...
## ⚠️ ВАЖНО: идёт переход на v3.0

Проект мигрирует с v2.x на v3.0 (компании / multi-tenancy / новые роли / переработанные задачи и мессенджер). **Перед любой работой смотри `PLAN_V3.md` в корне репозитория** — пошаговый чек-лист, в нём отмечается прогресс.

## Принципы разработки (ОБЯЗАТЕЛЬНО на всех этапах v3.0)
